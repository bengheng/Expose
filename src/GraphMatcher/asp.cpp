...
//long*row_mate;
    ...
    for (i=n-1;i>=0;--i) col_mate[i]=0;
    for (i=n-1;i>=0;--i) row_mate[i]=0;
    parent_row= new long[n];
    for (i=n-1;i>=0;--i) parent_row[i]=0;
    unchosen_row= new long[m];
    for (i=m-1;i>=0;--i) unchosen_row[i]=0;
//col_mate= new long[m];
    for (i=m-1;i>=0;--i) col_mate[i]=0;
//row_mate= new long[n];
    for (i=n-1;i>=0;--i) row_mate[i]=0;
    row_dec= new cost[m];
    for (i=m-1;i>=0;--i) row_dec[i]=0;
    col_inc= new cost[n];
    for (i=n-1;i>=0;--i) col_inc[i]=0;
    slack= new cost[n];
    for (i=n-1;i>=0;--i) slack[i]=0;
    slack_row= new long[n];
    for (i=n-1;i>=0;--i) slack_row[i]=0;
